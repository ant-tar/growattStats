...
Version **1.0.1-beta10** targets MODX Revolution **2.8.x**, PHP **7.4+** with cURL and JSON,
...
2. Upload `growattstats-1.0.1-beta10.transport.zip` through Extras > Installer.
