...
$_lang['growattstats_chart_note'] = 'The graph shows daily electricity production from the solar installation. Use the range selector or drag the navigator to inspect the history.';
