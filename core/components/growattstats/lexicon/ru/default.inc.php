...
$_lang['growattstats_err_api'] = 'Не удалось получить данные от Growatt API. Проверьте настройки api_url, token и plant_id.';
...
$_lang['growattstats_chart_note'] = 'График показывает суточную выработку солнечной установки. Используйте переключатель диапазона или навигатор, чтобы просматривать историю.';
